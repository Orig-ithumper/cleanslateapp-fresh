...
export default function DynamicIntakeForm() {
  ...
  const handleSubmit = () => {
    console.log("handleSubmit called", { selectedState, config });
    if (!selectedState || !config) {
      console.log("Blocked: missing state or config");
      return;
    }
    ...
    console.log("Immediately after setItem:", sessionStorage.getItem(`intake:${token}`));
    console.log("All keys after setItem:", Object.keys(sessionStorage));
  ...
  return (
    <main className="min-h-screen bg-gray-50 py-10 px-4">
      <div className="max-w-3xl mx-auto bg-white shadow-md rounded-lg p-8">
        ...
        <p className="texst-center text-gray-600 mb-8">
